    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('luggage_capacity', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('passenger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rides_booked', to=settings.AUTH_USER_MODEL)),
